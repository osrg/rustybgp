...
func main() {
	...
	// --- VPNv4 single label ---
	{
		...
		fmt.Printf("const GOBGP_VPNV4_SINGLE_LABEL: &[u8] = %s;\n\n", rustBytes(buf))
	}
	...
	// --- VPNv4 label stack [100, 200] ---
	{
		...
		fmt.Printf("const GOBGP_VPNV4_LABEL_STACK: &[u8] = %s;\n\n", rustBytes(buf))
	}
	...
	// --- VPNv4 default route ---
	{
		...
		fmt.Printf("const GOBGP_VPNV4_DEFAULT: &[u8] = %s;\n\n", rustBytes(buf))
	}
	...
	// --- VPNv6 single label ---
	{
		...
		fmt.Printf("const GOBGP_VPNV6_SINGLE_LABEL: &[u8] = %s;\n\n", rustBytes(buf))
	}
	...
	// --- VPNv6 label stack [100, 200] ---
	{
		...
		fmt.Printf("const GOBGP_VPNV6_LABEL_STACK: &[u8] = %s;\n\n", rustBytes(buf))
	}
}
